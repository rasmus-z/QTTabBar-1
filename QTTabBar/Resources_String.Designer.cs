...
namespace QTTabBarLib {
    ...
    public class Resources_String {
        ...
        /// <summary>
        ///   查找类似 Separator;Go back;Go forward;Groups;Recently Closed;Applications;New window;Clone this;Lock;Copy Tool;TopMost;Close;Close all but current;Close window;Close left;Close right;Up one level;Reload;Search;Opacity;Search Box 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Change the language.;Main language;Use built-in language:;Use language file:;Plugin language files;Language File Editor;Show Language Editor...;Original;Translated;Reset all entries to their original value?;Error saving file. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 View credits and version information.;Original code by {0};Lead Developer:;Other Developers:;Icons and graphics:;If you find QTTabBar useful, please consider making a small donation. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 http://www.qttabbar.sf.net 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Close;Close right;Close left;Close all but this;Add to Group;Create new Group;Lock;Clone this;New window;Copy path;Properties;Tab history;Groups;Undo closed;Last activated;Recently opened files;Browse folder;Close all but current;Close Window;Options;Unlock;Add to Application menu : ;items;Cancel;Branches;Remove this item from menu;O&amp;pen containing folder;Tab label;Tab order;Name;Path;Active;Lock the Toolbars;Merge tabs of other windows;Invert 的本地化字符串。
        /// </summary>
